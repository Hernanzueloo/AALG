...
short generate_search_times_aux(pfunc_search method, pfunc_key_generator generator,int order, char* file, int num_min, int num_max, int incr, int n_times,int n_perms);
